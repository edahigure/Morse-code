...
We write a program in Ruby to automate the process of decrypting a message that is writen in Morse code.
<a name="readme-top"></a>
...
**Morse code** This project is about how to use a module inside your class.
...
```sh
  cd my-folder
  git clone git@github.com:edahigure/Morse-code.git
```
...
Feel free to check the [issues page](https://github.com/edahigure/Morse-code/issues).
